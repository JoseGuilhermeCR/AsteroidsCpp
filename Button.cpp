...
void Button::update(const float deltaTime, const sf::Vector2i &mousePosition) {
    m_clicked = false;
    m_hovered = false;
...
void Button::setText(std::string text, unsigned int cSize, const sf::Font &font, const sf::Color &color) {
